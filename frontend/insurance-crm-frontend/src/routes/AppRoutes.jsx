...
function AppRoutes() {
  return (
    ...
    <Routes>
      ...
      <Route path="/admin/finance" element={<ProtectedRoute role="owner"><AdminFinance /></ProtectedRoute>} />
      ...
      <Route path="/agent/tasks" element={<ProtectedRoute role="agent"><AgentTaskDashboard/></ProtectedRoute>} />
