...
import {
  Bell, Settings, UserCircle, LayoutDashboard, Target, Phone, 
  BookOpen, Gift, PieChart, Search, ChevronDown, Plus, ChevronLeft, 
  ChevronRight, Edit2, CheckCircle, Filter
} from 'lucide-react';
    ...
    <div style={styles.dashboardWrapper}>
      ...
      <aside style={styles.sidebar}>
        <div style={styles.logoContainer}>
          ...
          <span style={styles.logoText}>CRM PRO</span>
        </div>
        <nav style={styles.navStack}>
          {[
            ...
            { name: 'Tasks', icon: BookOpen, active: true },
            { name: 'My Earnings', icon: Gift },
          ...
          <div style={styles.card}>
            ...
            <div style={styles.tableWrapper}>
              <table style={styles.table}>
                ...
                <tbody>
                  {loading ? (
                    <tr><td colSpan={6} style={styles.emptyState}>Loading your schedule...</td></tr>
                  ) : tasks.length === 0 ? (
...
const styles = {
  ...
  sidebar: { width: '240px', backgroundColor: 'white', borderRight: '1px solid #e2e8f0', padding: '24px', display: 'flex', flexDirection: 'column' },
  logoContainer: { display: 'flex', alignItems: 'center', gap: '12px', marginBottom: '40px' },
  logoIcon: { width: '32px', height: '32px', backgroundColor: '#2563eb', borderRadius: '50%', display: 'flex', alignItems: 'center', justifyCenter: 'center' },
  logoInner: { width: '14px', height: '14px', backgroundColor: 'white', borderRadius: '2px', transform: 'rotate(45deg)' },
  logoText: { fontSize: '20px', fontWeight: '900', color: '#1e293b' },
  navStack: { display: 'flex', flexDirection: 'column', gap: '8px' },
  navItem: { display: 'flex', alignItems: 'center', gap: '12px', padding: '12px 16px', borderRadius: '12px', border: 'none', backgroundColor: 'transparent', color: '#64748b', fontSize: '14px', fontWeight: '700', cursor: 'pointer', textAlign: 'left' },
  navItemActive: { display: 'flex', alignItems: 'center', gap: '12px', padding: '12px 16px', borderRadius: '12px', border: 'none', backgroundColor: '#2563eb', color: 'white', fontSize: '14px', fontWeight: '700', cursor: 'pointer', boxShadow: '0 10px 15px -3px rgba(37, 99, 235, 0.2)' },
  ...
  avatar: { width: '40px', height: '40px', backgroundColor: '#e2e8f0', borderRadius: '50%', overflow: 'hidden', border: '2px solid white', boxShadow: '0 1px 2px rgba(0,0,0,0.05)' },

  pagePadding: { padding: '32px' },
  ...
  primaryBtn: { display: 'flex', alignItems: 'center', gap: '8px', padding: '12px 24px', backgroundColor: '#fbbf24', color: 'white', border: 'none', borderRadius: '16px', fontWeight: '900', cursor: 'pointer', boxShadow: '0 4px 6px -1px rgba(251, 191, 36, 0.2)' },

  card: { backgroundColor: 'white', borderRadius: '32px', border: '1px solid #e2e8f0', padding: '32px', boxShadow: '0 1px 3px rgba(0,0,0,0.02)' },
  ...
  priorityBtn: { padding: '10px 20px', borderRadius: '16px', fontSize: '12px', fontWeight: '900', border: '1px solid transparent', cursor: 'pointer', transition: 'all 0.2s' },
  priorityBtnActive: { backgroundColor: '#2563eb', color: 'white', boxShadow: '0 10px 15px -3px rgba(37, 99, 235, 0.2)' },
  ...
  th: { padding: '16px', fontSize: '11px', fontWeight: '900', color: '#94a3b8', textTransform: 'uppercase', tracking: '0.1em' },
  ...
  tdTask: { padding: '16px', fontSize: '14px', color: '#1e40af', fontWeight: '800', cursor: 'pointer' },
  ...
  badge: { padding: '4px 12px', borderRadius: '8px', fontSize: '10px', fontWeight: '900', textTransform: 'uppercase' },
  ...
  doneBtn: { backgroundColor: '#10b981', color: 'white', border: 'none', padding: '6px', borderRadius: '8px', cursor: 'pointer', display: 'flex' },

  footer: { display: 'flex', justifyContent: 'space-between', alignItems: 'center', color: '#94a3b8', fontSize: '12px', fontWeight: '700' },
  pagination: { display: 'flex', gap: '4px' },
  pageBtn: { width: '36px', height: '36px', borderRadius: '8px', border: '1px solid #e2e8f0', backgroundColor: 'white', color: '#64748b', cursor: 'pointer', display: 'flex', alignItems: 'center', justifyContent: 'center' },
  pageBtnActive: { width: '36px', height: '36px', borderRadius: '8px', border: 'none', backgroundColor: '#2563eb', color: 'white', fontWeight: '700', cursor: 'pointer' },
